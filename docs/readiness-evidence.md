...
| MCP can read/write canvas state safely | `packages/mcp/src/index.ts`, `packages/mcp/src/tool-handlers.ts`, `pnpm mcp:smoke` covers 14 tools, source ingest, edges, search, import, and export | Proven locally |
