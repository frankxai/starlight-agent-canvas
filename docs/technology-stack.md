...
- Core package: Zod schemas, typed records, source artifacts, local file store, action runner, ingestion adapters, JSON import/export, and Markdown export.
...
- MCP package: `@modelcontextprotocol/sdk` stdio server with source ingest/update/action/import/export tools.
...
- Portable JSON import/export and Markdown exports.
