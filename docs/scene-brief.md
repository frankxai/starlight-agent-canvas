...
- Reference-only sources expose an `Attach context` panel for transcript, timestamp notes, OCR, visual observations, claims, and notes; attaching context rebuilds artifact chunks and updates readiness in place.
