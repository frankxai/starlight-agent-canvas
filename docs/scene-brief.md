...
- Right rail: source-grounded ask box, action drawer, editable selected node inspector immediately after the action drawer, setup/MCP status, local search, run log.
