...
- The Action Drawer exposes `Context gaps` whenever saved sources are not yet action-ready, and each gap jumps to the matching source enrichment textarea.
